...
/** Whether TransitAPI calls should use cached test results instead of real API results */
class MockTransitApiSettings(private val dataStore: DataStore<Preferences>) {
